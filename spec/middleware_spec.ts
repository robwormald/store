...
describe('ngRx middleware spec', () => {
  ...
  describe('todo integration spec', function() {
    ...
    injector = ReflectiveInjector.resolveAndCreate([
      provideStore(rootReducer, undefined, [reduxObservable(delegate)])
    ]);
    ...
    it('should log actions dispatched to the store', (done) => {
